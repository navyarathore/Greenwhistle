...
contract VolatileMarketplace is Ownable, ReentrancyGuard, Pausable {
    ...
    // Events
    event ItemListed(uint256 indexed listingId, address indexed seller, string gameItemId, uint256 price, uint256 quantity, ItemType itemType);
    event NftListed(uint256 indexed listingId, address indexed seller, uint256 indexed nftId, uint256 price, ItemType itemType);
    event ListingCancelled(uint256 indexed listingId, address indexed seller);
    event ItemSold(uint256 indexed listingId, address indexed seller, address indexed buyer, string gameItemId, uint256 price, uint256 quantity);
    event NftSold(uint256 indexed listingId, address indexed seller, address indexed buyer, uint256 nftId, uint256 price);
    ...
    function listNft(
        ...
        require(
            gameNfts.getApproved(nftId) == address(this) || 
     ...
     */
    function getGameItemPriceHistory(string memory gameItemId, uint256 limit) external view returns (SaleRecord[] memory) {
     ...
     */
    function getLowestPriceListingForGameItem(string memory gameItemId) external view returns (uint256 listingId, uint256 price) {
     ...
     */
    function getAllUniqueItemsWithPrices() external view returns (
     ...
     */
    function _verifyGameItemOwnership(address user, string memory gameItemId, uint256 quantity) internal view returns (bool) {
